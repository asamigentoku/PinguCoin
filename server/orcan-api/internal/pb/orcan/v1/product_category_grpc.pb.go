...
const (
	ProductCategoryService_ListProductCategories_FullMethodName = "/orcan.v1.ProductCategoryService/ListProductCategories"
	ProductCategoryService_GetProductCategory_FullMethodName    = "/orcan.v1.ProductCategoryService/GetProductCategory"
	ProductCategoryService_CreateProductCategory_FullMethodName = "/orcan.v1.ProductCategoryService/CreateProductCategory"
	ProductCategoryService_UpdateProductCategory_FullMethodName = "/orcan.v1.ProductCategoryService/UpdateProductCategory"
	ProductCategoryService_DeleteProductCategory_FullMethodName = "/orcan.v1.ProductCategoryService/DeleteProductCategory"
)
...
func (c *productCategoryServiceClient) ListProductCategories(ctx context.Context, in *ListProductCategoriesRequest, opts ...grpc.CallOption) (*ListProductCategoriesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListProductCategoriesResponse)
	err := c.cc.Invoke(ctx, ProductCategoryService_ListProductCategories_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productCategoryServiceClient) GetProductCategory(ctx context.Context, in *GetProductCategoryRequest, opts ...grpc.CallOption) (*GetProductCategoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetProductCategoryResponse)
	err := c.cc.Invoke(ctx, ProductCategoryService_GetProductCategory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productCategoryServiceClient) UpdateProductCategory(ctx context.Context, in *UpdateProductCategoryRequest, opts ...grpc.CallOption) (*UpdateProductCategoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *productCategoryServiceClient) DeleteProductCategory(ctx context.Context, in *DeleteProductCategoryRequest, opts ...grpc.CallOption) (*DeleteProductCategoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedProductCategoryServiceServer) ListProductCategories(context.Context, *ListProductCategoriesRequest) (*ListProductCategoriesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListProductCategories not implemented")
}
func (UnimplementedProductCategoryServiceServer) GetProductCategory(context.Context, *GetProductCategoryRequest) (*GetProductCategoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProductCategory not implemented")
}
...
func (UnimplementedProductCategoryServiceServer) UpdateProductCategory(context.Context, *UpdateProductCategoryRequest) (*UpdateProductCategoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateProductCategory not implemented")
}
func (UnimplementedProductCategoryServiceServer) DeleteProductCategory(context.Context, *DeleteProductCategoryRequest) (*DeleteProductCategoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteProductCategory not implemented")
}
...
func _ProductCategoryService_ListProductCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListProductCategoriesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductCategoryServiceServer).ListProductCategories(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductCategoryService_ListProductCategories_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductCategoryServiceServer).ListProductCategories(ctx, req.(*ListProductCategoriesRequest))
	}
...
var ProductCategoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "orcan.v1.ProductCategoryService",
	HandlerType: (*ProductCategoryServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ListProductCategories",
			Handler:    _ProductCategoryService_ListProductCategories_Handler,
		},
		{
	...
	Metadata: "orcan/v1/product_category.proto",
}
